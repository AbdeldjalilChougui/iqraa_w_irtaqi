...
import 'package:iqraa_w_irtaqi/ui/views/register/register_view.dart';
...
import 'package:iqraa_w_irtaqi/ui/views/login/login_viewmodel.dart';
              ...
              child: ListView(
                children: [
                  ...
                  const Row(
                    ...
                    children: [
                      Text("تسجيل الدخول", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 17)),
                    ],
                  ),
                  verticalSpaceMedium,
                  ...
                  verticalSpaceSmall,
                  Text('نسيت كلمة السر ؟'.tr(), style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 15, color: kMainColor1),)
                  ...
                  Container(
                    ...
                    child: Center(
                      child: model.isClicked! ? const Loader(color: Colors.white,).center() : Text('دخول'.tr(), style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w500),),
                    ),
                  ).gestures(
